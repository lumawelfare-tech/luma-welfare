...
const steps = [
  ...
  },
  {
    ...
    text: 'Join one or more packages, then record the package amount every month for verification. Each package tracks its own contributions — the money for hospital cover does not count toward business support. Online M-Pesa is launching soon.',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
