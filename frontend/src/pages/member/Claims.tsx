...
export function Claims() {
  ...
  async function handleFileUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (isDocumentTooLarge(file.size)) {
      setError(documentTooLargeMessage('File'))
      return
    }
              ...
              <div>
                ...
                {documents.length === 0 && (
                  <div className="mt-2 rounded-lg border border-dashed border-gray-200 p-4 text-center">
                    ...
                    <p className="text-[10px] text-gray-300">Upload supporting documents (photos, receipts, etc.) — {MAX_DOCUMENT_LABEL} or smaller.</p>
                  </div>
                )}
