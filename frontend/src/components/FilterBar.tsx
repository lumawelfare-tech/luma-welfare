...
/**
 * Desktop: inline chip toolbar + optional search.
 * Mobile: compact chips (scroll) + optional "Filters" button for drawer.
 */
  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      <div
        ...
        className="flex max-w-full gap-1 overflow-x-auto rounded-lg border border-gray-200 bg-white p-1"
      >
        {options.map((opt) => {
