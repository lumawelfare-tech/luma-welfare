-- Restore admin_search_members and admin_search_claims functions
-- These were supposed to be created by migration 20260827300000 but that migration
-- had a corrupt timestamp (hour 30) and its SQL never executed in production.
-- Only admin_search_contributions was created separately by 20260902200000.
...
-- ============================================================================
-- 2. Claims search — indexed status + member name join + pagination
-- ============================================================================
